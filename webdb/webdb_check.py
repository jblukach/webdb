    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        role.add_to_policy(
            _iam.PolicyStatement(
                ...
                resources = [
                    ...
                    'arn:aws:dynamodb:' + region + ':' + Stack.of(self).account + ':table/check',
                    'arn:aws:dynamodb:' + region + ':' + Stack.of(self).account + ':table/possibilities',
                    'arn:aws:dynamodb:' + region + ':' + Stack.of(self).account + ':table/metrics',
                ]
            )
        )
        ...
        check = _lambda.Function(
            ...
            environment = dict(
                ...
                CHECK_DYNAMODB_TABLE = 'check',
                POSSIBILITIES_DYNAMODB_TABLE = 'possibilities',
                METRICS_DYNAMODB_TABLE = 'metrics',
                PERM_DYNAMODB_TABLE = 'arn:aws:dynamodb:' + region + ':' + lunker.string_value + ':table/permutation',
                STATE_DYNAMODB_REGION = 'us-east-2',
                PERM_DYNAMODB_REGION = 'us-east-2',
                TTL_DAYS = '30'
            ),
